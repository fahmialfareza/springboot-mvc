package com.fahmialfareza.app.ws.ui.controller;

import com.fahmialfareza.app.ws.ui.model.request.UpdateUserDetailsRequestModel;
...
import com.fahmialfareza.app.ws.userservice.UserService;
...
public class UserController {
	...
	public String getUsers(@RequestParam(value = "page", defaultValue = "1") int page,
		...
		return ("get uses was called with page = " + page + " and limit = " + limit + " and sort = " + sort);
	}
